...
class _EditPageState extends State<EditPage> {
  ...
  void initState() {
    super.initState();
    tag_controller = TextEditingController(text: widget.passwordData.tag);
  ...
  PasswordData generatePasswordData() {
    return PasswordData(
        ...
        isFav: widget.passwordData.isFav);
  }
                  ...
                  if (isTagValid &&
                    ...
                    if (mounted) {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) =>
                              HomePage(userID: widget.passwordData.userID)));
                    }
                  } else {
  ...
  Widget isFavButton() {
    return OutlinedButton(
      style: OutlinedButton.styleFrom(
          ...
          backgroundColor: widget.passwordData.isFav == 1
              ? StyleColor.red
              : StyleColor.white),
      onPressed: () {
        setState(() {
          widget.passwordData.isFav == 1
              ? widget.passwordData.isFav = 0
              : widget.passwordData.isFav = 1;
        });
      },
      child: widget.passwordData.isFav == 1
          ? const Icon(
              Icons.favorite,
